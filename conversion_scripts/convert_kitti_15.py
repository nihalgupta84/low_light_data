...
def add_darkness(image_path, darkness_factor=0.06):
...
if __name__ == '__main__':
    src_dir = "./KITTI_2015"
    dst_dir = r"/media/anil/New Volume/Nihal/Low_Light_dataset/KITTI_2015_Dark"
    checkpoint_file = 'kitti_checkpoints.json'
